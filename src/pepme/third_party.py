...
class ThirdPartyModel:
    ...
    def __init__(
        ...
        self.plugin = Plugin()
        self.plugin.setup(plugins_root=Path(save_dir), repo_url=repo_url)
...
class Plugin:
    ...
    def setup(self, plugins_root: Path, repo_url: str) -> None:
        """
    ...
    def run(
        ...
        Args:
            ...
            input_data (dict): Dictionary of arguments to serialize and pass.
